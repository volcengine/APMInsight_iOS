...
## Change Log
### 5.2.7 (※Recommended※)
* optimization: optimize configuration update strategy

### 5.2.6
* bugfix: fix symbols duplicate

### 5.2.4
* optimization: optimize OOM misjudgment

### 5.2.3
* optimization: optimize the processing logic of extreme scenarios to avoid throwing exceptions
